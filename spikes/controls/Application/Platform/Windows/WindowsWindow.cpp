...
WindowsWindow::WindowsWindow( HINSTANCE instance, uint16_t width, uint16_t height/*, Keyboard &keyboard, Mouse &mouse, Graphics &graphics*/ ) :
    Window( width, height ),
    hinstance( instance ),
...
void WindowsWindow::RegisterWindowClass()
{
    ...
    wcex.lpfnWndProc   = WindowsWindow::_WindowProc;
    wcex.cbClsExtra    = 0;
    wcex.cbWndExtra    = 0;
...
void WindowsWindow::RegisterRawDevices()
{
...
LRESULT WindowsWindow::_WindowProc( HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam )
{
