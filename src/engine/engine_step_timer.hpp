...
namespace Engine
{
	...
	public:
			...
			m_targetElapsedTicks(TicksPerSecond / 60)
		{
			...
			{
				throw new std::runtime_error( "Unable to query game timer frequency." );
			}

			if (!QueryPerformanceCounter(&m_qpcLastTime))
			{
                throw new std::runtime_error( "Unable to query game timer time." );
			}
		...
		void ResetElapsedTime()
		{
			if (!QueryPerformanceCounter(&m_qpcLastTime))
			{
                throw new std::runtime_error( "Unable to reset game timer." );
			}
