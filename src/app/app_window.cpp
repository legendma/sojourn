...
Framework::Window *Framework::Window::m_this = nullptr;

Framework::Window::Window() : m_window_caption( L"Sojourn" ),
                              m_window_width( 800 ),
                              m_window_height( 600 ),
                              m_dpi( 96 )
{
    Framework::Window::m_this = this;
}

LRESULT CALLBACK
Framework::Window::MainWndProc( HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam )
{
    // Forward hwnd on because we can get messages (e.g., WM_CREATE)
    // before CreateWindow returns, and thus before m_hwnd is valid.
    return m_this->WindowProc( hWnd, message, wParam, lParam );
}
 
LRESULT Framework::Window::WindowProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	switch( msg )
	{
...
bool Framework::Window::CreateMainWindow( HINSTANCE hinstance )
{
    m_hinstance = hinstance;

    WNDCLASS wc;
    wc.style = CS_HREDRAW | CS_VREDRAW;
    wc.lpfnWndProc = Framework::Window::MainWndProc;
    wc.cbClsExtra = 0;
    wc.cbWndExtra = 0;
