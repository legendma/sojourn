...
Client::Window *Client::Window::m_this = nullptr;

Client::Window::Window() : m_window_caption( L"Sojourn Client" ),
                              m_window_width( 800 ),
                              m_window_height( 600 ),
                              m_dpi( 96 )
{
    Client::Window::m_this = this;
}
...
bool Client::Window::CreateMainWindow( HINSTANCE hinstance )
{
